...
/** @type {string} */
const CACHE_VERSION = '1735347890|17241158512';
/** @type {string} */
const CACHE_PREFIX = 'Godot 2D Platfor-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'GodotPlatformer.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["GodotPlatformer.html","GodotPlatformer.js","GodotPlatformer.offline.html","GodotPlatformer.icon.png","GodotPlatformer.apple-touch-icon.png","GodotPlatformer.worker.js","GodotPlatformer.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["GodotPlatformer.wasm","GodotPlatformer.pck"];
